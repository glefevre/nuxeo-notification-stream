...
exports.config = {
  ...
  //
  specs: require('./specs-processor.js')(process.argv),
  // Patterns to exclude.
  exclude: [
  ...
  baseUrl: process.env.NUXEO_URL ? process.env.NUXEO_URL : 'http://localhost:8080/nuxeo/',
  //
  ...
  cucumberOpts: {
    require: [path.join(__dirname, 'test/features/step_definitions/**/*.js', 'node_modules/@nuxeo/nuxeo-web-ui-ftest/test/features/step_definitions/**/*.js')],        // <string[]> (file/dir) require files before executing features
